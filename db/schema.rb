...
ActiveRecord::Schema.define(version: 20150103154648) do
  ...
  add_index "transactions", ["bank_account_id"], name: "fk_transactions_2_idx", using: :btree
  add_index "transactions", ["user_id"], name: "fk_transactions_1_idx", using: :btree
  ...
  add_index "user_login_history", ["user_id"], name: "fk_baa_user_login_history_baa_user_idx", using: :btree
